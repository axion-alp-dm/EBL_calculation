...
def import_spectrum_data(parent_dir=None,
...
def dictionary_datatype(obs_type,
                        lambda_min=0., lambda_max=1e15,
                        parent_dir=None,
                        plot_measurs=False,
                        obs_not_taken=None):
    if parent_dir is None:
        parent_dir = 'data/cb_measurs/optical_data_2023/'
