...
from ebl_measurements.EBL_measurs_plot import *
...
config_data = read_config_file('scripts/input_data_change_sfr.yml')
...
plt.figure(fig)
plot_ebl_measurement_woUpperLims('ebl_measurements/EBL_measurements.yml')
