...
class EBL(GridInterpolator):
    ...
    def __init__(self, z, lmu, nuInu, kx=1, ky=1, **kwargs):
        ...
        self._axion_mass = kwargs.pop('axion_mass', None)
        self._axion_gayy = kwargs.pop('axion_gayy', None)
    ...
    @staticmethod
    def readmodel(model, kx=1, ky=1, **kwargs):
        """
        ...
        return EBL(z, lmu, nuInu, model=model, kx=kx, ky=ky, **kwargs)
    ...
    def ebl_array(self, z, lmu):
        ...
        if self._axion_mass is not None \
                and self._axion_gayy is not None:
            result += cosmic_axion_contr(
                lmu, z, self._axion_mass, self._axion_gayy)
        return result
